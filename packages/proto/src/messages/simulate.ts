...
import * as sm from '../proto/cosmos/tx/v1beta1/service'

export function bytesToSimulateRequest(bytes: Uint8Array) {
  return sm.cosmos.tx.v1beta1.SimulateRequest.deserialize(bytes)
}
